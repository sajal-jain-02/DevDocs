...
const SnippetForm = ({
  ...
  return (
    <form className='w-full' onSubmit={handleSubmit}>
        ...
        <textarea
        className="w-full h-40 border border-gray-300 bg-gray-900 rounded p-2 mb-4 resize-none"
        ...
        <select 
            ...
            className="w-64 border border-gray-300 bg-gray-900 rounded p-2 mb-4"
        >
